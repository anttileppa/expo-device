 ...
 * ```
 */
export const supportedCpuArchitectures: string[] | null = ExpoDevice ? ExpoDevice.supportedCpuArchitectures : null;
 ...
 * @platform android
 */
export const osBuildFingerprint: string | null = ExpoDevice ? ExpoDevice.osBuildFingerprint || null : null;
 ...
 * @platform android
 */
export const platformApiLevel: number | null = ExpoDevice ? ExpoDevice.platformApiLevel || null : null;
